  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
        theme: ThemeData(
            ...
            brightness:
                Brightness.light, // Light theme ensures white base colors
        ...
        home: animated_splash.AnimatedSplash(
          type: animated_splash.Transition.fade,
          curve: Curves.easeOutQuint,
          navigator: const AuthService(),
          durationInSeconds: 1,
